...
@hydra.main(config_path="../../config", config_name="cfg_high_level_rw")
def main(cfg):
    # load robot
    ...
    model = hydra.utils.instantiate(
        cfg.agent, dataset_path=dataset_path, env=env, model_free=None, use_aff=use_affordances
    )
    ...
    evaluate_aff(model, env, use_affordances=use_affordances, max_ts=cfg.max_timesteps)
