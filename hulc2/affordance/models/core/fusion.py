...
class FusionConv(Fusion):
    ...
    def __init__(self, input_dim=3):
        ...
        self.conv = nn.Sequential(nn.ReLU(True), nn.Conv2d(input_dim * 2, input_dim, kernel_size=1, bias=False))
...
class FusionConvLat(Fusion):
    ...
    def __init__(self, input_dim=3, output_dim=3):
        ...
        self.conv = nn.Sequential(nn.ReLU(True), nn.Conv2d(input_dim, output_dim, kernel_size=1, bias=False))
...
class CrossModalAttention2d(nn.Module):
    ...
    def __init__(self, spacial_dim=7, embed_dim=1024, num_heads=32, output_dim=1024, lang_dim=512, lang_max_tokens=77):
        super().__init__()
