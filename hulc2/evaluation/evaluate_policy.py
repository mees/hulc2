...
def main():
    ...
    parser.add_argument(
        "--aff_train_folder",
        default=None,
        help="Affordance model train folder to use model-based model-free combination method.",
    )
    parser.add_argument(
        "--aff_checkpoint",
        default="val_err",
        help="Affordance model checkpoint name w/extension to use model-based model-free combination method.",
    )
    # Overriding scene
    parser.add_argument(
